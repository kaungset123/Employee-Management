...
<div class="app-main__outer">
    <div>
        ...
        <div class="card-header p-5"><b style="font-size: 23px;">Running Projects</b>
            <div class="btn-actions-pane-right">
                <div class="nav">
                    <a href="{{ route('project.index') }}" class="btn-pill btn-wide  btn btn-outline-alternate btn-sm">
                        Projects
                    </a>
                    <a  href="{{ route('project.progress') }}" class="btn-pill btn-wide active mr-1 ml-1  btn btn-outline-alternate btn-sm">
                        Running
                    </a>
