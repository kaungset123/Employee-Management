                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="email" id="exampleEmail" placeholder="Email here..." value="{{old('email')}}" type="email" class="form-control">
                                            @error('email')
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="password" id="examplePassword" placeholder="Password here..." value="{{old('password')}}" type="password" class="form-control">
                                            @error('password')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
